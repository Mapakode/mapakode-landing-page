  ...
  return (
    <section className="py-24 px-6 bg-[#0b4ed7] relative overflow-hidden">
      ...
      <div className="relative max-w-3xl mx-auto text-center">
        <p className="text-white/60 text-xs font-semibold tracking-widest uppercase mb-5">Ready to Build?</p>
        ...
        <p className="text-white/70 text-base leading-relaxed max-w-md mx-auto mb-10">
          We build fast, fair, and tailored. Let&apos;s talk about what you want to create.
        </p>
